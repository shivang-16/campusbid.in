...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col justify-between bg-gradient-to-r from-purple-100 via-white to-teal-100 font-sans pt-28">
      {/* Navbar */}
      <Navbar />

      {/* Hero Section */}
      <main className="flex flex-col items-center py-12 px-4 md:px-6 lg:px-12 text-center h-full justify-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center mt-6 md:mt-8 space-y-4 sm:space-y-0 sm:space-x-4">
          <a
            ...
            className="bg-gray-700 text-white px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-lg font-semibold hover:bg-gray-900 transition duration-300 text-sm md:text-base"
          >
            Learn More
          </a>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-teal-200 text-teal-800 font-semibold flex items-center px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-lg hover:bg-teal-300 transition duration-200 ease-in-out text-sm md:text-base"
          >
          ...
          <div className="max-w-5xl mx-auto text-center px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                <div key={feature.title} className="p-4 md:p-6 rounded-lg shadow-sm hover:shadow transition duration-300 text-center">
          ...
          <div className="max-w-5xl mx-auto text-center px-4 md:px-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {[
                ...
                <div key={index} className="p-4 md:p-6 rounded-lg shadow-sm hover:shadow text-left">
      ...
      {/* Footer */}
      <footer className="w-full py-4 md:py-6 px-4 md:px-6 text-center bg-gradient-to-r from-purple-100 via-white to-teal-100 text-gray-700 font-medium">
